...
(function tempchatV3() {
  ...
  /* ---------------------------------------------------------------
     4. AUTO MUTE
        SOFT mute -- never sets track.enabled = false. Disabling the
        track would feed the detector silence, so it could never hear
        you speak again and would latch muted forever.
  --------------------------------------------------------------- */
  const AUTO_MUTE_SILENCE_BLOCKS = 28; // ~1.2s quiet before muting
